...
@Component
public class EarphoneExcelParser {
    ...
    private static final Map<String, String> HEADER_MAP = Map.ofEntries(
            ...
            Map.entry("쇼핑 URL", "shoppingUrl")
    );

    public List<EarphoneImportRow> parse(Path excelPath) {
        ...
        try (InputStream in = Files.newInputStream(excelPath);
            ...
            List<EarphoneImportRow> result = new ArrayList<>();
            ...
            for (int i = 1; i <= sheet.getLastRowNum(); i++) {
                ...
                result.add(
                        EarphoneImportRow.builder()
                                ...
                                .shoppingUrl(map.get("shoppingUrl"))
                                .build()
                );
            }
