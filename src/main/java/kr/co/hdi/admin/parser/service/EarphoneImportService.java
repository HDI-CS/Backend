...
import kr.co.hdi.admin.parser.dto.EarphoneExcelParser;
...
public class EarphoneImportService {
    ...
    private final EarphoneExcelParser parser;
    ...
    public void importFromLocal(String excelPathStr, String imageRootStr, Long yearId) {
        ...
        List<EarphoneImportRow> rows = parser.parse(excelPath);

        for (int i = 0; i < rows.size(); i++) {

            EarphoneImportRow row = rows.get(i);
            ...
            try {
                ...
                System.out.println("==== EARPHONE IMPORT ====");
    ...
    private Path findFolder(Path rootDir, String code) {
        ...
        String normalized = String.valueOf(Integer.parseInt(code));
    ...
    private String buildS3Key(String code, String type, String ext) {
        return "2026/ID/PR_" + code + "_eeep_" + type + "." + ext;
    }
